#!/bin/bash
#SBATCH --job-name=blastx_sprot
#SBATCH --output=/home/darmstrong4/mc_rework/logs/blastx_sprot_%j.out
#SBATCH --error=/home/darmstrong4/mc_rework/logs/blastx_sprot_%j.err
